...
[EMQ X ](https://www.emqx.cn/blog/category/emqx)[使用指南](https://www.emqx.cn/blog/category/tutorial)

[编辑](https://github.com/emqx/blog/edit/main/zh/202007/enable-two-way-ssl-for-emqx.md)[反馈](https://github.com/emqx/blog/issues/new?body=File: [/zh/202007/enable-two-way-ssl-for-emqx.md](https://www.emqx.cn/blog/enable-two-way-ssl-for-emqx))
...
当配置完成并重启 EMQ X 后，我们使用 [MQTT 客户端工具 - MQTT X](https://mqttx.app/zh)（该工具跨平台且支持 [MQTT 5.0](https://www.emqx.cn/mqtt/mqtt5)），来验证 TLS 双向认证服务是否正常运行。
...
[![img](https://static.emqx.net/images/active/hstream.png)](https://hstream.io/?utm_source=emqxio-blog&utm_medium=activities-ads&utm_campaign=hstream-marketing)

为流式数据存储和实时处理而生的流数据库

[了解详情](https://hstream.io/?utm_source=emqxio-blog&utm_medium=activities-ads&utm_campaign=hstream-marketing)

[![img](https://static.emqx.net/images/active/cloud.png)](https://cloud.emqx.cn/?utm_source=emqxio-blog&utm_medium=activities-ads&utm_campaign=cloud-marketing)

全托管的 MQTT 云服务，开始 180 天免费试用

[
  ](https://cloud.emqx.cn/?utm_source=emqxio-blog&utm_medium=activities-ads&utm_campaign=cloud-marketing)